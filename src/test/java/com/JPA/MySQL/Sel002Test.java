...
public class Sel002Test {
  ...
  public void sel002() {
    ...
    driver.findElement(By.cssSelector(".movieButton:nth-child(5)")).click();
    ...
    driver.findElement(By.cssSelector(".inputActorFeedback")).sendKeys("feedb 01");
    ...
    {
      WebElement element = driver.findElement(By.cssSelector("div:nth-child(1) > div > .btn-outline-warning"));
      Actions builder = new Actions(driver);
      builder.moveToElement(element).perform();
    }
    driver.findElement(By.cssSelector("div:nth-child(3) > div > .actorFeedDeleteButton")).click();
    driver.findElement(By.cssSelector("div:nth-child(2) > div > .btn-outline-warning")).click();
    driver.findElement(By.cssSelector(".updateActorFeedback")).click();
    driver.findElement(By.cssSelector(".updateActorFeedback")).sendKeys("this is update");
